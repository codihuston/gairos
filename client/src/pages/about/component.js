...
export default function Home() {
  return (
    <div>
      ...
      <p>
        This is a project was developed by Codi Huston. The name &ldquo;
        {APP_NAME}&rdquo; is the name of the project itself; the finalized name
        of this app has not yet been determined. You can follow the progress of
        this app <a href="http://github.com/codihuston/gairos/">in the repo</a>!
        Feel free to drop any suggestions there as well =). You are also welcome
        to <a href="https://twitter.com/codingwithcodi">tweet at me!</a>
      </p>
    </div>
  );
}
